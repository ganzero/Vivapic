...
bool vectorCheck(int x, int y, int u, int v){
        if(x <= WIDTH && u <= WIDTH && y <= HEIGHT && v <= HEIGHT && x >= 0 && y >= 0 && u >= 0 && v >= 0){
                return true;
        }
        return false;
}
...
bool circleCheck(int x, int y, int r){
        if(x <= WIDTH && y <= HEIGHT && x >= 0 && y >= 0 && r > 0 && x+r <= WIDTH && x-r >= 0 && y+r <= HEIGHT && y-r >= 0){
                return true;
        }
        return false;
}

bool blockCheck(int x, int y, int w, int h){
        if(x <= WIDTH && y <= HEIGHT && x >= 0 && y >= 0 && w >= 0 && h >= 0 && x+w <= WIDTH && y+h <= HEIGHT){
                return true;
        }
        return false;
}
